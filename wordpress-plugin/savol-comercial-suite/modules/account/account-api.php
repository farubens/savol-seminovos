...
define('SAVOL_ACCOUNT_TOKEN_META', '_savol_account_token');
define('SAVOL_ACCOUNT_FAVORITES_META', '_savol_vehicle_favorites');
define('SAVOL_ACCOUNT_VISITED_META', '_savol_vehicle_visited');
